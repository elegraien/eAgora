...
namespace eAgoraV3.Models
{
    ...
    public partial class FIN_TYPE_DTC1_F21
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public FIN_TYPE_DTC1_F21()
        {
            this.FIN_DETAILS_COMMANDES_F07 = new HashSet<FIN_DETAILS_COMMANDES_F07>();
        }
    
        public int F21_ID { get; set; }
        public string F21_LIBELLE { get; set; }
        public Nullable<int> F21_ORDRE { get; set; }
