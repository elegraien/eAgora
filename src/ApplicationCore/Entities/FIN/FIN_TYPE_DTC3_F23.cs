...
namespace eAgoraV3.Models
{
    ...
    public partial class FIN_TYPE_DTC3_F23
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public FIN_TYPE_DTC3_F23()
        {
            this.FIN_DETAILS_COMMANDES_F07 = new HashSet<FIN_DETAILS_COMMANDES_F07>();
        }
    
        public int F23_ID { get; set; }
        public string F23_LIBELLE { get; set; }
        public Nullable<int> F23_ORDRE { get; set; }
