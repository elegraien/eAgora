...
namespace eAgoraV3.Models
{
    ...
    public partial class FIN_TYPE_DTC4_F24
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public FIN_TYPE_DTC4_F24()
        {
            this.FIN_DETAILS_COMMANDES_F07 = new HashSet<FIN_DETAILS_COMMANDES_F07>();
        }
    
        public int F24_ID { get; set; }
        public string F24_LIBELLE { get; set; }
        public Nullable<int> F24_ORDRE { get; set; }
