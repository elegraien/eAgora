...
namespace eAgoraV3.Models
{
    ...
    public partial class HOT_TYPE_SS_RESA2_H15
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public HOT_TYPE_SS_RESA2_H15()
        {
            this.HOT_SOUS_RESERVATION_H02 = new HashSet<HOT_SOUS_RESERVATION_H02>();
        }
    
        public int H15_ID { get; set; }
        public string H15_LIBELLE { get; set; }
        public Nullable<int> H15_ORDRE { get; set; }
