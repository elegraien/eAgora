...
namespace eAgoraV3.Models
{
    ...
    public partial class HOT_TYPE_SS_RESA3_H16
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public HOT_TYPE_SS_RESA3_H16()
        {
            this.HOT_SOUS_RESERVATION_H02 = new HashSet<HOT_SOUS_RESERVATION_H02>();
        }
    
        public int H16_ID { get; set; }
        public string H16_LIBELLE { get; set; }
        public Nullable<int> H16_ORDRE { get; set; }
