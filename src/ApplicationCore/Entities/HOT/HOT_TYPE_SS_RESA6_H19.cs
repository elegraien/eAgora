...
namespace eAgoraV3.Models
{
    ...
    public partial class HOT_TYPE_SS_RESA6_H19
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public HOT_TYPE_SS_RESA6_H19()
        {
            this.HOT_SOUS_RESERVATION_H02 = new HashSet<HOT_SOUS_RESERVATION_H02>();
        }
    
        public int H19_ID { get; set; }
        public string H19_LIBELLE { get; set; }
        public Nullable<int> H19_ORDRE { get; set; }
