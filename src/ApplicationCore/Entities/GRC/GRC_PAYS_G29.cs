...
namespace eAgoraV3.Models
{
    ...
    public partial class GRC_PAYS_G29
    {
        ...
        public GRC_PAYS_G29()
        {
            ...
            this.GRC_REGION_G30 = new HashSet<GRC_REGION_G30>();
        }
    
        public int G29_ID { get; set; }
        public string G29_LIBELLE { get; set; }
        public Nullable<short> G29_ORDRE { get; set; }
        public string G29_PREFIX { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<GRC_REGION_G30> GRC_REGION_G30 { get; set; }
    }
}
